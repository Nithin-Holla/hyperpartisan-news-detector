...
class HyperpartisanDataset(data.Dataset):
	...
	def __init__(self, filename: str, word_vector: Vectors, use_data: int):
	...
	def __getitem__(self, idx):
		...
		return hyperpartisan, bias, body_indexed_seq, body_length_in_sent, body_length_in_tokens, title_indexed_seq, title_length
	...
	def _parse_csv_file(self, filename: str, embedding_vector: Vectors, use_data: int) \
		...
		return hyperpartisan, bias, title_tokens, body_tokens, word_vectors